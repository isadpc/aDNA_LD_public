...
rule filt_male_1240k_x_chrom:
    ...
    output:
        ...
        vcf_male_only_idx=REICH_LAB_1240K_DATA_DIR
        + "v42.4.1240K.chrX.male_only.vcf.gz.tbi",
    shell:
        """
...
rule generate_chrX_1kg_panel_vcf:
    ...
    output:
        tmp_chrX_pos=temp(
            "data/hap_copying/chrX_male_analysis/vcf_real1kg/chrX.{panel}.real_1kg.male_only.pos"
        ),
...
rule merge_real_1kg_vcf_chrX_1240K_panel:
    ...
    output:
        tmp_chrX_pos=temp(
            "data/hap_copying/chrX_male_analysis/vcf_real1kg/merged/chrX.{panel}.real_1kg.v42_merged.1240K_only.male_only.sites.pos"
        ),
...
rule interp_gen_hap_panel_chrX_real1kg:
    ...
    run:
        ...
        rec_df = pd.read_csv(
            input.genmap, sep="\s+", low_memory=True, dtype=rec_map_types
        )
        ...
        np.savez_compressed(
            ...
            ref=ref_alleles,
            alt=alt_alleles,
            bp_pos=real_pos_filt,
            cm_pos=interp_rec_pos,
        )
...
rule gen_all_aDNA_datasets:
    input:
        expand(
            "data/hap_copying/chrX_male_analysis/tot_chrX_panel/tot_chrX.{panel}.real_1kg.chrX.male_only.recmap_{rec}.total.npz",
            panel=["ceu", "eur", "fullkg"],
            rec="deCODE",
        ),
